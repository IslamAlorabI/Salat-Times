...
// Moved out of SettingsView so non-UI code — and eventually the widget extension —
// can reach the city list without compiling the whole settings screen.

nonisolated enum Continent: String, CaseIterable, Identifiable {
    case africa = "Africa"
    case asia = "Asia"
...
nonisolated enum City: String, CaseIterable, Identifiable {
    // Africa
